  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        day_selected: "[&:not([disabled])]:bg-red-400 bg-primary text-primary-foreground hover:bg-primary hover:text-primary-foreground focus:bg-primary focus:text-primary-foreground",
